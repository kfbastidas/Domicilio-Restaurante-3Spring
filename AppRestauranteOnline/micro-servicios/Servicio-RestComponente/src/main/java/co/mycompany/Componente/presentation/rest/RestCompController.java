...
public class RestCompController {
	@Autowired
	...
	@ResponseBody
	public List<Long> findComponentes(@PathVariable Long id,@PathVariable String dia) throws ComponenteDomainException {
		return restComponenteService.findMenuComponentes(id, dia);
	}
	...
	public RestComponente createComponenteDia(@RequestBody RestComponente restComp) throws ComponenteDomainException {
		return restComponenteService.createComponenteSemanal(restComp);
	}
	...
	public void deleteComponente(@PathVariable Long idRest,@PathVariable Long idComp,@PathVariable String dia) throws ComponenteDomainException {
		restComponenteService.deleteComponenteSemanal(idRest,idComp,dia);
	}
}